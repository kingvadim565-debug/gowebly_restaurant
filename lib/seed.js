...
function seedDb() {
  ...
  return {
    settings: {
      name: 'GoWebly Restauracja',
      tagline: 'Mogilno · rezerwacje online',
      phone: '514 318 457',
      ...
      mapsQuery: 'Wodna, 88-300 Mogilno',
    ...
    gallery: [
      g('/img/hero.jpg', 'Sala restauracji GoWebly', 'hero', 1),
